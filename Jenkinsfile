pipeline {
    ...
    environment {
        ...
        AWS_DOCKER_REGISTRY = '462052762279.dkr.ecr.us-east-2.amazonaws.com'
        ...
        stage('Deploy to AWS'){
            ...
            steps {
                ...
                sh '''
                    ...
                    aws ecs wait services-stable --cluster learnJekinisApp-Cluster-Prod --services LearnJenkinsApp-TaskDefinition-Prod-service-c2yg3kzl
